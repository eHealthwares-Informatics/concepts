...
export declare class ConceptsController {
    ...
    constructor(conceptsService: ConceptsService, loincSeeder: LoincSeederService, icdSeeder: ICDSeederService);
    ...
    seedICD(triggeredBy?: string): Promise<import("./seeders/icd.seeder").SeederResult>;
    getICDImportHistory(limit?: string): Promise<{
        data: import("./entities").ImportTrackingEntity[];
    }>;
    getICDImportStatus(): Promise<{
        data: import("./entities").ImportTrackingEntity | null;
    }>;
}
