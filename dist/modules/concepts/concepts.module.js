...
exports.ConceptsModule = ConceptsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [concepts_service_1.ConceptsService, loinc_seeder_1.LoincSeederService, seed_loinc_command_1.SeedLoincCommand, google_sheets_service_1.GoogleSheetsService],
        exports: [concepts_service_1.ConceptsService, loinc_seeder_1.LoincSeederService],
    })
], ConceptsModule);
