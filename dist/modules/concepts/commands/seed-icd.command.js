...
var SeedICDCommand_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.SeedICDCommand = void 0;
const nest_commander_1 = require("nest-commander");
const common_1 = require("@nestjs/common");
const icd_seeder_1 = require("../seeders/icd.seeder");
let SeedICDCommand = SeedICDCommand_1 = class SeedICDCommand extends nest_commander_1.CommandRunner {
    icdSeeder;
    logger = new common_1.Logger(SeedICDCommand_1.name);
    constructor(icdSeeder) {
        super();
...
exports.SeedICDCommand = SeedICDCommand;
exports.SeedICDCommand = SeedICDCommand = SeedICDCommand_1 = __decorate([
    (0, common_1.Injectable)(),
    (0, nest_commander_1.Command)({
        name: 'seed:icd',
        description: 'Import ICD-10 data from Google Sheets',
    }),
    __metadata("design:paramtypes", [icd_seeder_1.ICDSeederService])
], SeedICDCommand);
//# sourceMappingURL=seed-icd.command.js.map