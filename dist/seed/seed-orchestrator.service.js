...
const dictionary_seeder_1 = require("../modules/concepts/seeders/dictionary.seeder");
...
let SeedOrchestratorService = SeedOrchestratorService_1 = class SeedOrchestratorService {
    ...
    constructor(facilitySeeder, loincSeeder, icdSeeder, drugSeeder, dictionarySeeder) {
        this.facilitySeeder = facilitySeeder;
        this.loincSeeder = loincSeeder;
        this.icdSeeder = icdSeeder;
        this.drugSeeder = drugSeeder;
        this.dictionarySeeder = dictionarySeeder;
    }
    async seedAll() {
        const result = {
